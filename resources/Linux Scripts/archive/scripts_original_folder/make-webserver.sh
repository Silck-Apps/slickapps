...
mysql -pR1m@dmin -e "create user 'bennettw'@'%' identified by 'sambo174'; grant all privileges on *.* to 'bennettw'@'%' identified by 'sambo174' with grant option; flush privilegs;"
