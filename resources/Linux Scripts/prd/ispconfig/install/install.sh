...
zypper -n install --force-resolution amavisd-new 
zypper -n install --force-resolution clamav 
zypper -n install --force-resolution clamav-db 
zypper -n install --force-resolution zoo unzip unrar bzip2 unarj 
zypper -n install --force-resolution perl-DBD-mysql 
zypper -n install --force-resolution spamassassin
...
cp $scriptsdir/php.ini /etc/php5/cli
